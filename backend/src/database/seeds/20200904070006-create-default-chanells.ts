...
module.exports = {
  up: (queryInterface: QueryInterface) => {
    return queryInterface.sequelize.query(
      ...
      INSERT INTO public."Whatsapps" (id, "session", qrcode, status, battery, plugged, "createdAt", "updatedAt", "name", "isDefault", retries, "tenantId", phone, "number", "isDeleted", "tokenTelegram", "type", "instagramUser", "instagramKey", "tokenHook", "tokenAPI", "wabaBSP", "isActive", "fbPageId", "fbObject") VALUES(4, '', '', 'DISCONNECTED', '20', false, '2021-03-11 23:23:17.000', '2022-07-19 15:55:28.096', 'Messenger 01', false, 0, 1, '{}'::jsonb, '', false, NULL, 'messenger', NULL, NULL, '', NULL, NULL, true, NULL, NULL);
      `
    );
  },
