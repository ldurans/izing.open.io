...
module.exports = {
  up: (queryInterface: QueryInterface) => {
    return queryInterface.sequelize.query(
      `
      INSERT INTO Tenants(STATUS, ownerId, createdAt, updatedAt, name, businessHours, messageBusinessHours) VALUES
      ('active', NULL, '2021-03-10 17:28:29.000', '2021-03-10 17:28:29.000', 'Empresa 01','[
